...
public class studentDAO {
 public void insertStudent(studentVO item) throws Exception {
  ...
  Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","201412409","201412409");
 ...
 public List<studentVO> selectStudent() throws Exception { //List에 record set을 담아 넘겨 준다
	   ...
	   Class.forName("oracle.jdbc.driver.OracleDriver");
	   Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","201412409","201412409"); // DB 접속
